...
/// </summary>
public sealed class BurnEffect : ActiveEffect
{
    public const string EffectType = "Burn";

    public BurnEffect(int value, int duration, EffectTarget target, int stackCount = 1)
